...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="{{ route('backend.pages.index') }}" class="logo">
                <!-- mini logo for sidebar mini 50x50 pixels -->
                <span class="logo-mini"><b>S</b>B</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>Saltan</b>B</span>
            </a>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li>
                                            ...
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="https://cdn1.iconfinder.com/data/icons/avatar-2-2/512/Casual_Man_2-512.png" class="img-circle"
                                                        alt="User Image">
                                                </div>
                                                <h4>
                                                    Support Team
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="https://cdn1.iconfinder.com/data/icons/avatar-2-2/512/Casual_Man_2-512.png" class="user-image" alt="User Image">
                                <span class="hidden-xs">Admin</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header">
                                    <img src="https://cdn1.iconfinder.com/data/icons/avatar-2-2/512/Casual_Man_2-512.png" class="img-circle" alt="User Image">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="{{ (Route::currentRouteName() == 'backend.pages.index') ? 'active' : ' ' }} treeview">
                        <a href="#">
    ...
    <script src="https://cdn.tiny.cloud/1/goxsrkemjx1o6r8wwsfswkcnfvk0tnrxgx4chkoqx3dsxlwf/tinymce/5/tinymce.min.js"></script>
    @stack('scripts')
